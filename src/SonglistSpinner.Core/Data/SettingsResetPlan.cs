...
public static class SettingsResetPlan
{
    ...
    [
        ...
        Define(nameof(SettingsDto.PlayedListSeparator), PlayedSongsSection, "Field separator",
            ...
            (settings, value) => settings.PlayedListSeparator = value),
        Define(nameof(SettingsDto.PlayedListShowLabels), PlayedSongsSection, "Field labels",
            SettingsResetScope.PlayedSongsPanel,
            settings => settings.PlayedListShowLabels,
            (settings, value) => settings.PlayedListShowLabels = value),
        Define(nameof(SettingsDto.PlayedListShowFieldHeaders), PlayedSongsSection, "Field header row",
            SettingsResetScope.PlayedSongsPanel,
            settings => settings.PlayedListShowFieldHeaders,
            (settings, value) => settings.PlayedListShowFieldHeaders = value),
        ...
        Define(nameof(SettingsDto.NowPlayingSeparator), NowPlayingSection, "Field separator",
            SettingsResetScope.NowPlayingPanel,
            settings => settings.NowPlayingSeparator,
            (settings, value) => settings.NowPlayingSeparator = value),
        Define(nameof(SettingsDto.NowPlayingShowLabels), NowPlayingSection, "Field labels",
            SettingsResetScope.NowPlayingPanel,
            settings => settings.NowPlayingShowLabels,
            (settings, value) => settings.NowPlayingShowLabels = value),
